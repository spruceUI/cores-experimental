"""Genesis Plus GX Wide contract: engine binding, provenance markers, reviewed diagnostics."""
...
from core_pipeline_lib.contracts import genesis_plus_gx_wide as contract_module
...
def _proves(log_text: str, arch: str) -> bool:
    return contract_module.genesis_plus_gx_wide_log_proves_contract(
        log_text,
        CORE_ID,
        arch,
        _H["SOURCE_COMMIT"],
...
class GenesisPlusGxWideContractTests(unittest.TestCase):
